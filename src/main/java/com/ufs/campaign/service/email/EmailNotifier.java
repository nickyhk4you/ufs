...
public class EmailNotifier {
    ...
    public void send(String messageSubject, String messageTo, String attachment) {
        ...
        props.put("mail.user", "alerts@alerts.unileverfoodsolutions.com.cn");
        // 访问SMTP服务时需要提供的密码(在控制台选择发信地址进行设置)
        props.put("mail.password", "feXurLfMyDLFT62R");
...
//        mailSession.setDebug(true);
        ...
        try {
            ...
            InternetAddress to = new InternetAddress(messageTo);
...
//            message.setReplyTo(a);
//            // 设置收件人邮件地址，比如yyy@yyy.com
//            InternetAddress to = new InternetAddress("khu@adobe.com");
//            message.setRecipient(MimeMessage.RecipientType.TO, to);
//            //如果同时发给多人，才将上面两行替换为如下（因为部分收信系统的一些限制，尽量每次投递给一个人；同时我们限制单次允许发送的人数是30人）：
//            //InternetAddress[] adds = new InternetAddress[2];
//            //adds[0] = new InternetAddress("xxxxx@qq.com");
